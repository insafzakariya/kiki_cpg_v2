...
public class MobitelController {
	...
	public ResponseEntity<Object> activateDataBundle(@RequestBody MobitelActivationDto mobitelActivationDto, HttpServletRequest request){
		...
		try{
			...
			if(isValied) {
				String resp = mobitelService.pay(mobitelActivationDto.getMobileNo(), mobitelActivationDto.getViewerId(), mobitelActivationDto.getActivationStatus(),mobitelActivationDto.getSubscriptionPaymentId(), mobitelActivationDto.getPlanId(), mobitelActivationDto.isTrial());
