...
<div class="preloader">
    <div class="loader_img"><img id="imgSrc" src="<c:url value='/static/img/loader.gif'/>" alt="loading..." height="64" width="64"></div>
</div>
<div class="container">
        ...
        <div class="col-md-6 col-md-offset-3">
             <div class="lockscreen-container">
              <!--   <div id="output"></div>
                ...
                <div class="form-box">
                    <div class="form">
						<div     class="locked " style="font-weight: bold;font-size: 20">Choose your preferred method.<br></div>
						<div>  <small class="locked ">select your payment method to unlock<br></small></div>
						<div>  <small class="locked ">access to exclusive content.<br></small></div>
						<div id="paymentOptions">
	                            ...
	                            <!-- 	<div class="row" style="margin-left:0px; margin-right:0px;">
                                	...
                                	<c:if test="${empty ideabiz_subscribed}">
		                                ...
		                                <input type="radio" class="stv-radio-button" name="optionsRadios" value="4" id="button3" />
		                                <label for="button3">
		                                <div class="row">
		                                <div class="col-md-4 pull-left"><img src="/susilawebpay/static/assets/images/dialog-new.jpg" class="img-rounded" alt="Cinque Terre" width="50" height="50"> </div>
		                                <div class="col-md-8 pull-right"><p><strong>Dialog</strong></p><p>Add to bill</p></div>
		                                </div>
		                                </label>
		                                </c:if>
		                                </div> 
									...
									<c:if test="${empty mobitel_subscribed}">
		                                ...
		                                <input type="radio" class="stv-radio-button" name="optionsRadios" value="5" id="button4" />
		                                <label for="button4">
		                                <div class="row">
		                                <div class="col-md-4 pull-left"><img src="/susilawebpay/static/img/authors/madd.jpg" class="img-rounded" alt="Cinque Terre" width="50" height="50"> </div>
		                                <div class="col-md-8 pull-right"><p><strong>Mobitel</strong></p><p><strong>Add to bill</strong></p></div>
		                                </div>
	                                ...
	                                <input type="radio" class="stv-radio-button" name="optionsRadios" value="6" id="button5" />
	                                <label for="button5">
	                                <div class="row">
	                                <div class="col-md-4 pull-left"><img src="/susilawebpay/static/img/authors/scratchcard.jpg" class="img-rounded" alt="Cinque Terre" width="50" height="50"> </div>
	                                <div class="col-md-8 pull-right"><p><strong>Use Scratch </strong></p><p><strong>Card code</strong></p></div>
	                                </div>
	                                </label>
	                                </c:if>
	                            	</div>
		                       ...
		                       <!--  <div class="panel-body">
		                        ...
		                        <form id="ezCashForm" action="https://ipg.dialog.lk/ezCashIPGExtranet/servlet_sentinal" method="post">
		                            <input id="encryptedMerchantInvoice" type="hidden" value="${merchantInvoice}" name="merchantInvoice">
		                        </form>
	...
	<script>
	    (function(h,o,t,j,a,r){
	        ...
	        h._hjSettings={hjid:1633284,hjsv:6};
