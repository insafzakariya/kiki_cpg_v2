...
<script type="text/javascript">
	...
	$("#btn_proceed").click(
			function() {
				...
				$.get(baseURL + "/rest/common/verifyNumber/" + method + "/"
						+ mobile_no, function(resp, status) {
					console.log(resp);
					console.log(status);
					if (status == "success") {
						if (method == 4 && resp == "success") {
							var day = sessionStorage.getItem("day");
							$.get(baseURL + "/otp/send/" + mobile_no + "/"
									+ day, function(resp, status) {
								sessionStorage.setItem('server_ref',
										resp.SERVER_REF);
							...
							var url = "https://services.mobitel.lk/MCCPortal/service/?compId=SusilaTV&reqType=ACTIVE&servId=SUWS&returnUrl="+baseURL+"/mobitel/mobitelPay&bridgeID="+ generalData.subscriptionPaymentId;
